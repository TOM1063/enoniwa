...
const LogLineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_logline_free(ptr >>> 0));
/**
*/
export class LogLine {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        LogLineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_logline_free(ptr);
    }
    /**
    * @param {number} id
    */
    constructor(id) {
        const ret = wasm.logline_new(id);
    ...
    */
    add_point(x, y, time) {
        wasm.logline_add_point(this.__wbg_ptr, x, y, time);
    }
    /**
    ...
    * @returns {boolean}
    */
    is_intersection(mouse_x, mouse_y, size_x, size_y) {
        const ret = wasm.logline_is_intersection(this.__wbg_ptr, mouse_x, mouse_y, size_x, size_y);
        return ret !== 0;
    }
    /**
    * @returns {number}
    */
    points_length() {
        const ret = wasm.logline_points_length(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} index
    ...
    */
    get_point(index) {
        const ret = wasm.logline_get_point(this.__wbg_ptr, index);
    ...
    */
    get_color() {
        const ret = wasm.logline_get_color(this.__wbg_ptr);
...
export class Point {
    ...
    */
    time() {
        const ret = wasm.point_time(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_logline_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
